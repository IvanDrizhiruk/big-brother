...
public class ExcelReportGenerator {
    ...
    public void generateReport(PeopleView peopleView) {
        ...
        String reportFileName = String.format("[%s]: %s-%s.xlsx", peopleView.getTeamName(), peopleView.getStartPeriod(), peopleView.getEndPeriod());
        File reportFile = new File(reportRoot, reportFileName);
    ...
    private void generatePeopleReport(PeopleView peopleView, XSSFWorkbook workbook, XSSFSheet sheet) {
        ...
        Stream.generate()
        peopleView.startPeriod
        peopleView.endPeriod;
        ...
        peopleView.getPersonMetrics()
                .forEach(personMetric -> {
                    ...
                    if (!dayWorkLogForPeople.isEmpty()) {
                        ...
                        dayWorkLogForPeople
                                .forEach(dayWorkLogForPerson -> {
                                    ...
                                    List<TaskWorkingLogMetrics> dailyTaskLogs = dayWorkLogForPerson.getDailyTaskLogs();
                    ...
                    List<TaskWorkingLogMetrics> sprintTaskLogs = personMetric.getSprintTaskLogs();
                    if (!sprintTaskLogs.isEmpty()) {
                        ...
                        TaskWorkingLogMetrics totalSprintTaskLog = personMetric.getTotalSprintTaskLog();
