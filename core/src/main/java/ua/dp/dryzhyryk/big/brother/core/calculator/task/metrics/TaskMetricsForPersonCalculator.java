...
public class TaskMetricsForPersonCalculator {
	...
	private TaskMetrics toTaskMetrics(
		...
		int timeSpentOnTaskByPeriodInMinutes = spentMinutesForDay.entrySet().stream()
		...
		return TaskMetrics.builder()
				...
				.timeSpentOnTaskByPeriodInMinutes(timeSpentOnTaskByPeriodInMinutes)
				.timeSpentOnTaskInMinutes(timeSpentOnTaskInMinutes)
				.allTimeSpendOnTaskInMinutes(task.getTimeSpentMinutes())
