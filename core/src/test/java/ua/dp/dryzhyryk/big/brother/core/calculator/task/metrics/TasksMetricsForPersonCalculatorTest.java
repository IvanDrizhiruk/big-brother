...
class TasksMetricsForPersonCalculatorTest {
    ...
    public void taskWorkingLogMetricsShouldBeAggregatedByUser() {
        ...
        PeopleSearchConditions peopleSearchConditions = PeopleSearchConditions.builder()
                ...
                .build();
//
//        Map<String, TaskMetrics> personsMetricsForPeopleFromTask1 = Map.of(
...
//                        List.of(newTimeSpentByDay(day3, 100))));
        ...
        TaskMetricsForPersonCalculator taskMetricsForPersonCalculator = mock(TaskMetricsForPersonCalculator.class);
//        when(taskMetricsForPersonCalculator.calculateTaskMetricsForPerson(eq(task1), any(), any()))
...
//                .thenReturn(personsMetricsForPeopleFromTask2);
        ...
        //when
//        TasksMetricsForPersonCalculatorTest calculator = new TasksMetricsForPersonCalculator(
...
//                .thenReturn(personsMetricsForPeopleFromTask1);
//
//        TaskWorkingLogsForPeopleValidator taskMetricsForPeopleValidator = mockTaskMetricsForPersonValidator();
//
//        List<TasksWorkingLogsForPerson> expected = List.of(
//                TasksWorkingLogsForPerson.builder()
//                        .person("person#1")
